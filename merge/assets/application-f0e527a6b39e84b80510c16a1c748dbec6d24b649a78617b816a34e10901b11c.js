(() => {
  ...
  // app/javascript/components/add_jquery.js
  ...
  // app/javascript/components/member.js
  var initMemberForm = () => {
    const p = document.getElementById("member_expected_amount_eth");
    const d = document.getElementById("member_expected_amount");
    if (p && d) {
      d.addEventListener(
        "input",
        function() {
    ...
    $('input[name="member[us_investor]"]').on("change", function() {
      if (this.value == "true") {
        $("fieldset.member_accredited_us_investor").parent().removeClass("d-none");
      } else {
        $("fieldset.member_accredited_us_investor").parent().addClass("d-none");
      }
    });
  };
